...
exports.list = async (req, res) => {
  try {
    ...
    res.render('admin/customers/list', { customers, layout: 'main-admin', title: 'Quản lý khách hàng' });
  } catch (error) {
...
exports.getCustomerById = async (req, res) => {
  ...
  try {
    ...
    res.render('admin/customers/detail', { customer, layout: 'main-admin', title: 'Chi tiết khách hàng' });
  } catch (error) {
