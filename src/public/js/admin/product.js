  ...
  if (detailModal) {
    document
      ...
      .addEventListener("click", function (event) {
        ...
        const profit = row.getAttribute("data-profit");
        ...
        detailModal.querySelector(
          ".modal-title"
        ).textContent = `Chi tiết sách: ${bookTitle || "Không xác định"}`;
        detailModal.querySelector("#detail-book-id").textContent = bookId;
        detailModal.querySelector("#detail-book-title").textContent =
          bookTitle || "Không xác định";
        detailModal.querySelector("#detail-category").textContent =
          category || "Không xác định";
        detailModal.querySelector("#detail-author").textContent =
          author || "Không xác định";
        detailModal.querySelector("#detail-publisher").textContent =
          publisher || "Không xác định";
        detailModal.querySelector("#detail-price").textContent = price || "0";
        detailModal.querySelector("#detail-discount").textContent =
          discount || "0";
        detailModal.querySelector("#detail-profit").textContent = profit || "0";
        detailModal.querySelector("#detail-quantity").textContent =
          quantity || "0";
        detailModal.querySelector("#detail-description").textContent =
          description || "Không có mô tả";
        detailModal.querySelector("#detail-image").src =
          image || "/img/placeholder.jpg";
        detailModal.querySelector("#detail-created").textContent =
          created || "Không xác định";
